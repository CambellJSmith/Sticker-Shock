...
if ! "$PYTHON_BIN" -c "from PIL import Image; import numpy; from scipy import ndimage" >/dev/null 2>&1; then # Detects border-processing dependencies in both new and existing environments.
